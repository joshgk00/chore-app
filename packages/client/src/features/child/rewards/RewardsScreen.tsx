      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-[var(--color-bg)] p-4">
        <div aria-live="assertive" className="text-center">
          ...
          <button
            ...
            className="mt-6 rounded-full bg-amber-500 px-6 py-3 font-display font-bold text-white shadow-card transition-all duration-200 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-500"
          >
            Try Again
          </button>
        </div>
    ...
    <div className="min-h-screen bg-[var(--color-bg)] p-4">
      ...
      {rewardList.length === 0 ? (
        <div className="mt-12 text-center" aria-live="polite">
          <p className="text-xl font-bold text-[var(--color-text-muted)]">No rewards available yet.</p>
          <p className="mt-2 text-[var(--color-text-muted)]">Keep earning points!</p>
        </div>
      ) : (
